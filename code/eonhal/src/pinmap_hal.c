...
#if defined(STM32G070KB) || defined(STM32G071KB) || defined(STM32G071K8)
#define TOTAL_PINS 28
#endif

#if !defined(STM32G070RB) && !defined(STM32G071RB) && !defined(STM32G070CB) && !defined(STM32G070KB) && !defined(STM32G071KB) && !defined(STM32G071K8)
#error "You should select a supported device first."
#endif
 ...
 */
        ...
        /* PA3 - 3*/ {GPIOA, LL_GPIO_PIN_3, LL_ADC_CHANNEL_3, TIM15, LL_TIM_CHANNEL_CH2, AF_5, AF_0, AF_NONE, AF_1},
        ...
        /* PA12 - 12*/ {GPIOA, LL_GPIO_PIN_12, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_0, AF_6, AF_1},
        ...
        /* PB1 - 16*/ {GPIOB, LL_GPIO_PIN_1, LL_ADC_CHANNEL_9, TIM3, LL_TIM_CHANNEL_CH4, AF_1, AF_NONE, AF_NONE, AF_4},
        /* PB2 - 17*/ {GPIOB, LL_GPIO_PIN_2, LL_ADC_CHANNEL_10, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_1, AF_NONE, AF_4},
        /* PB3 - 18*/ {GPIOB, LL_GPIO_PIN_3, ADC_CHANNEL_NONE, TIM1, LL_TIM_CHANNEL_CH2, AF_1, AF_0, AF_NONE, AF_4},
        ...
        /* PB14 - 29*/ {GPIOB, LL_GPIO_PIN_14, ADC_CHANNEL_NONE, TIM15, LL_TIM_CHANNEL_CH1, AF_5, AF_0, AF_6, AF_4},
        ...
        /* PD2 - 49*/ {GPIOD, LL_GPIO_PIN_2, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_NONE, AF_NONE, AF_0},
        /* PD3 - 50*/ {GPIOD, LL_GPIO_PIN_3, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_1, AF_NONE, AF_NONE},
#if TOTAL_PINS > 42
        /* PD4 - 51*/ {GPIOD, LL_GPIO_PIN_4, ADC_CHANNEL_NONE, NULL, TIM_CHANNEL_NONE, AF_NONE, AF_1, AF_NONE, AF_0},
